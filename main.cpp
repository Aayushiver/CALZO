...
int main()
{
    ...
    do {
        ...
        if (!cin || CALZO <= 0 || CALZO > 5) {
            cin.clear();
            cin.ignore(1000, '\n');
            cout << "\nI'm sorry but that is not an option. Please answer 1, 2, 3 ,4 or 5." << endl;
        }
...
//Start Year Born Option
        if (CALZO == 3) {
            ...
            while ((cout << "\nEnter your current age." << endl) && !(cin >> iAge)) {
                cout << "\nI'm sorry but that is an invalid answer. Please answer using numbers." << endl;
                cin.clear();
                cin.ignore(1000, '\n');
            }
            iBirth = iYear-iAge;
            cout << "\nYou were born in the year " << iBirth << endl;
        }
